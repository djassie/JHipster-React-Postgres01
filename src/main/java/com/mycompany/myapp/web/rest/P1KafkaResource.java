...
@RestController
@RequestMapping("/api/p-1-kafka")
public class P1KafkaResource {

    private static final String PRODUCER_BINDING_NAME = "binding-out-0";

    private final Logger log = LoggerFactory.getLogger(P1KafkaResource.class);
    private final KafkaConsumer kafkaConsumer;
    private final StreamBridge streamBridge;

    public P1KafkaResource(StreamBridge streamBridge, KafkaConsumer kafkaConsumer) {
